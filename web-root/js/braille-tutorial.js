...
//	timeOut=setTimeout("nextStep()", introLength);
	step=0;nextStep(); //For debugging from a specific step.
}
...
--To Do--
When the user types something incorrectly, check to see if what they typed is something that has been covered already - if it has, add both what the user got wrong and what they typed to the redo list - if it hasn't, ignore it
